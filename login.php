...
<head>
    ...
    <style>
    :root {
        --primary-color:rgb(90, 136, 110);
        --secondary-color:rgb(0, 177, 80);
        --light-color:rgb(172, 201, 156);
    }
...
<body>
    ...
    <ul class="navbar-nav ms-auto">
        <li class="nav-item">
            <a class="nav-link home-button active" aria-current="page" href="index.php?page=landing_page">
